...
export const customizableFieldsCatalog = [
  ...
  { key: "vysotaTilHrebtsivShvh", zone: "ШВХ / ГВХ", label: "Висота тіл хребців" },
  { key: "vysotaTilHrebtsivGvh", zone: "ГВХ", label: "Висота тіл хребців (Th)" },
  { key: "mizhkhrebtseviPromizhky", zone: "ШВХ / ГВХ / ПВХ", label: "Міжхребцеві проміжки" },
  {
  ...
  { key: "plechovyiSuhlobViews", zone: "Плечовий суглоб", label: "Норма/Не норма" },
  { key: "kliuchytsiaViews", zone: "Ключиця", label: "Норма/Не норма" },
  { key: "rebraViews", zone: "Ребра", label: "Норма/Не норма" },
  { key: "liktovyiSuhlobViews", zone: "Ліктьовий суглоб", label: "Норма/Не норма" },
  {
  ...
  { key: "kulshovyiSuhlobViews", zone: "Кульшовий суглоб", label: "Норма/Не норма" },
  { key: "kolinnyiSuhlobViews", zone: "Колінний суглоб", label: "Норма/Не норма" },
  {
  ...
  { key: "peredniViddilyStopyViews", zone: "Передні відділи стопи", label: "Норма/Не норма" },
];
