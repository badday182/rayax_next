...
export const HomilkovoStopnyiSuhlob = () => {
  const [
    selectedHomilkovoStopnyiSuhlobViews,
    setSelectedHomilkovoStopnyiSuhlobViews,
  ] = useState(homilkovoStopnyiSuhlobViews[0]);
  const [homilkovoStopnyiSuhlobCounter, setHomilkovoStopnyiSuhlobCounter] =
    useState([{ id: uuidv4() }]);
  ...
  return (
    <div className="">
      <AddOptionBlock
        ...
        onAddClick={() =>
          handleAddOption(
            setHomilkovoStopnyiSuhlobCounter,
            homilkovoStopnyiSuhlobCounter
          )
        }
