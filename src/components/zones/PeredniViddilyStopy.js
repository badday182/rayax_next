...
export const PeredniViddilyStopy = () => {
  const [
    selectedPeredniViddilyStopyViews,
    setSelectedPeredniViddilyStopyViews,
  ] = useState(peredniViddilyStopyViews[0]);
  const [peredniViddilyStopyCounter, setPeredniViddilyStopyCounter] = useState([
    { id: uuidv4() },
  ]);
  ...
  return (
    <div className="">
      <AddOptionBlock
        ...
        onAddClick={() =>
          handleAddOption(
            setPeredniViddilyStopyCounter,
            peredniViddilyStopyCounter
          )
        }
