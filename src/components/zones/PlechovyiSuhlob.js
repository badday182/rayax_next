...
export const PlechovyiSuhlob = () => {
  const [selectedPlechovyiSuhlobViews, setSelectedPlechovyiSuhlobViews] =
    useState(plechovyiSuhlobViews[0]);
  const [plechovyiSuhlobCounter, setPlechovyiSuhlobCounter] = useState([
    { id: uuidv4() },
  ]);
  ...
  return (
    <div>
      <AddOptionBlock
        ...
        onAddClick={() =>
          handleAddOption(setPlechovyiSuhlobCounter, plechovyiSuhlobCounter)
        }
        onDeleteClick={(deleteId) =>
          handleDeleteOption(deleteId, [
            plechovyiSuhlobCounter,
            setPlechovyiSuhlobCounter,
          ])
        }
      />
    </div>
