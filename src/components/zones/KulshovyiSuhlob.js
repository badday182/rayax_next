...
export const KulshovyiSuhlob = () => {
  const [selectedKulshovyiSuhlobViews, setSelectedKulshovyiSuhlobViews] =
    useState(kulshovyiSuhlobViews[0]);
  const [kulshovyiSuhlobCounter, setKulshovyiSuhlobCounter] = useState([
    { id: uuidv4() },
  ]);
  ...
  return (
    <div className="">
      <AddOptionBlock
        ...
        onAddClick={() =>
          handleAddOption(setKulshovyiSuhlobCounter, kulshovyiSuhlobCounter)
        }
        onDeleteClick={(deleteId) =>
          handleDeleteOption(deleteId, [
            kulshovyiSuhlobCounter,
            setKulshovyiSuhlobCounter,
          ])
        }
      />
    </div>
