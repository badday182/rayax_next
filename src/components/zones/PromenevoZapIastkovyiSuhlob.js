...
export const PromenevoZapIastkovyiSuhlob = () => {
  const [
    selectedPromenevoZapIastkovyiSuhlobViews,
    setSelectedPromenevoZapIastkovyiSuhlobViews,
  ] = useState(promenevoZapIastkovyiSuhlobViews[0]);
  const [
    promenevoZapIastkovyiSuhlobCounter,
    setPromenevoZapIastkovyiSuhlobCounter,
  ] = useState([{ id: uuidv4() }]);
